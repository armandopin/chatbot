...
//      (newPayload.output && newPayload.output.text);
	...
	var textExists = "";
	if (newPayload.input && newPayload.input.text) {
		textExists = newPayload.input.text;
	} else if (newPayload.output && newPayload.output.generic) {
		if (newPayload.output.intents.length > 0) {
			textExists = newPayload.output.intents[0].intent;
		} else {
			textExists = newPayload.output.generic[0].text;
		}
	}
